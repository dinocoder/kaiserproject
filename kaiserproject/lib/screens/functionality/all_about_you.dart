...
class AllAboutYou extends StatefulWidget {
  @override
  _AllAboutYou createState() => _AllAboutYou();
}

class _AllAboutYou extends State<AllAboutYou> {
  @override
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                Padding(
                  padding: const EdgeInsets.fromLTRB(120, 0, 110, 0),
                  child: Container(
